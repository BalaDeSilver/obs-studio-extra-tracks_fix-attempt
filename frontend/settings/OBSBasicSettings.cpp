...
#undef ADD_HOTKEY_FOCUS_TYPE
	...
	connect(ui->advOutRecTrack6, &QCheckBox::toggled, this,
		&OBSBasicSettings::AdvReplayBufferChanged);
	connect(ui->advOutRecTrack7, &QCheckBox::toggled, this,
		&OBSBasicSettings::AdvReplayBufferChanged);
	connect(ui->advOutRecTrack8, &QCheckBox::toggled, this,
		&OBSBasicSettings::AdvReplayBufferChanged);
	connect(ui->advOutRecTrack9, &QCheckBox::toggled, this,
		&OBSBasicSettings::AdvReplayBufferChanged);
	connect(ui->advOutRecTrack10, &QCheckBox::toggled, this,
		&OBSBasicSettings::AdvReplayBufferChanged);
	connect(ui->advOutRecTrack11, &QCheckBox::toggled, this,
		&OBSBasicSettings::AdvReplayBufferChanged);
	connect(ui->advOutRecTrack12, &QCheckBox::toggled, this,
		&OBSBasicSettings::AdvReplayBufferChanged);
	connect(ui->advOutTrack1Bitrate, &QComboBox::currentIndexChanged, this,
		&OBSBasicSettings::AdvReplayBufferChanged);
	connect(ui->advOutTrack2Bitrate, &QComboBox::currentIndexChanged, this,
	...
	ui->advOutTrack7->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track7"));
	ui->advOutTrack8->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track8"));
	ui->advOutTrack9->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track9"));
	ui->advOutTrack10->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track10"));
	ui->advOutTrack11->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track11"));
	ui->advOutTrack12->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track12"));
	...
	ui->advOutRecTrack6->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track6"));
	ui->advOutRecTrack7->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track7"));
	ui->advOutRecTrack8->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track8"));
	ui->advOutRecTrack9->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track9"));
	ui->advOutRecTrack10->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track10"));
	ui->advOutRecTrack11->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track11"));
	ui->advOutRecTrack12->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track12"));
	...
	ui->advOutFFTrack6->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track6"));
	ui->advOutFFTrack7->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track7"));
	ui->advOutFFTrack8->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track8"));
	ui->advOutFFTrack9->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track9"));
	ui->advOutFFTrack10->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track10"));
	ui->advOutFFTrack11->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track11"));
	ui->advOutFFTrack12->setAccessibleName(
		QTStr("Basic.Settings.Output.Adv.Audio.Track12"));
	...
	connect(ui->advOutRecTrack6, &QCheckBox::clicked, this,
		&OBSBasicSettings::AdvOutRecCheckWarnings);
	connect(ui->advOutRecTrack7, &QCheckBox::clicked, this,
		&OBSBasicSettings::AdvOutRecCheckWarnings);
	connect(ui->advOutRecTrack8, &QCheckBox::clicked, this,
		&OBSBasicSettings::AdvOutRecCheckWarnings);
	connect(ui->advOutRecTrack9, &QCheckBox::clicked, this,
		&OBSBasicSettings::AdvOutRecCheckWarnings);
	connect(ui->advOutRecTrack10, &QCheckBox::clicked, this,
		&OBSBasicSettings::AdvOutRecCheckWarnings);
	connect(ui->advOutRecTrack11, &QCheckBox::clicked, this,
		&OBSBasicSettings::AdvOutRecCheckWarnings);
	connect(ui->advOutRecTrack12, &QCheckBox::clicked, this,
		&OBSBasicSettings::AdvOutRecCheckWarnings);
...
void OBSBasicSettings::LoadAdvOutputAudioSettings()
{
	...
	int track7Bitrate =
		config_get_uint(main->Config(), "AdvOut", "Track7Bitrate");
	int track8Bitrate =
		config_get_uint(main->Config(), "AdvOut", "Track8Bitrate");
	int track9Bitrate =
		config_get_uint(main->Config(), "AdvOut", "Track9Bitrate");
	int track10Bitrate =
		config_get_uint(main->Config(), "AdvOut", "Track10Bitrate");
	int track11Bitrate =
		config_get_uint(main->Config(), "AdvOut", "Track11Bitrate");
	int track12Bitrate =
		config_get_uint(main->Config(), "AdvOut", "Track12Bitrate");
	const char *name1 =
	...
	const char *name7 =
		config_get_string(main->Config(), "AdvOut", "Track7Name");
	const char *name8 =
		config_get_string(main->Config(), "AdvOut", "Track8Name");
	const char *name9 =
		config_get_string(main->Config(), "AdvOut", "Track9Name");
	const char *name10 =
		config_get_string(main->Config(), "AdvOut", "Track10Name");
	const char *name11 =
		config_get_string(main->Config(), "AdvOut", "Track11Name");
	const char *name12 =
		config_get_string(main->Config(), "AdvOut", "Track12Name");
	...
	PopulateAdvancedBitrates(
		{ui->advOutTrack1Bitrate, ui->advOutTrack2Bitrate,
		 ...
		 ui->advOutTrack7Bitrate, ui->advOutTrack8Bitrate,
		 ui->advOutTrack9Bitrate, ui->advOutTrack10Bitrate,
		 ui->advOutTrack11Bitrate, ui->advOutTrack12Bitrate},
		encoder_id,
	...
	track7Bitrate = FindClosestAvailableAudioBitrate(
		ui->advOutTrack7Bitrate, track7Bitrate);
	track8Bitrate = FindClosestAvailableAudioBitrate(
		ui->advOutTrack8Bitrate, track8Bitrate);
	track9Bitrate = FindClosestAvailableAudioBitrate(
		ui->advOutTrack9Bitrate, track9Bitrate);
	track10Bitrate = FindClosestAvailableAudioBitrate(
		ui->advOutTrack10Bitrate, track10Bitrate);
	track11Bitrate = FindClosestAvailableAudioBitrate(
		ui->advOutTrack11Bitrate, track11Bitrate);
	track12Bitrate = FindClosestAvailableAudioBitrate(
		ui->advOutTrack12Bitrate, track12Bitrate);
	...
	SetComboByName(ui->advOutTrack7Bitrate,
		       std::to_string(track7Bitrate).c_str());
	SetComboByName(ui->advOutTrack8Bitrate,
		       std::to_string(track8Bitrate).c_str());
	SetComboByName(ui->advOutTrack9Bitrate,
		       std::to_string(track9Bitrate).c_str());
	SetComboByName(ui->advOutTrack10Bitrate,
		       std::to_string(track10Bitrate).c_str());
	SetComboByName(ui->advOutTrack11Bitrate,
		       std::to_string(track11Bitrate).c_str());
	SetComboByName(ui->advOutTrack12Bitrate,
		       std::to_string(track12Bitrate).c_str());
	...
	ui->advOutTrack7Name->setText(name7);
	ui->advOutTrack8Name->setText(name8);
	ui->advOutTrack9Name->setText(name9);
...
static void SaveTrackIndex(config_t *config, const char *section,
			   ...
			   QAbstractButton *check6, QAbstractButton *check7,
			   QAbstractButton *check8, QAbstractButton *check9,
			   QAbstractButton *check10, QAbstractButton *check11,
...
void OBSBasicSettings::SaveOutputSettings()
{
	...
	SaveTrackIndex(main->Config(), "AdvOut", "TrackIndex", ui->advOutTrack1,
		       ...
		       ui->advOutTrack5, ui->advOutTrack6, ui->advOutTrack7,
		       ui->advOutTrack8, ui->advOutTrack9, ui->advOutTrack10,
		       ui->advOutTrack11, ui->advOutTrack12);
	...
	if (surround) {
		...
		RestrictResetBitrates(
			{ui->simpleOutputABitrate, ui->advOutTrack1Bitrate,
			 ...
			 ui->advOutTrack6Bitrate, ui->advOutTrack7Bitrate,
			 ui->advOutTrack8Bitrate, ui->advOutTrack9Bitrate,
			 ui->advOutTrack10Bitrate, ui->advOutTrack11Bitrate,
...
void OBSBasicSettings::AdvOutRecCheckWarnings()
{
	...
	uint32_t tracks =
		...
		Checked(ui->advOutRecTrack7) + Checked(ui->advOutRecTrack8) +
		Checked(ui->advOutRecTrack9) + Checked(ui->advOutRecTrack10) +
		Checked(ui->advOutRecTrack11) + Checked(ui->advOutRecTrack12);
...
int OBSBasicSettings::AdvOutGetSelectedAudioTracks()
{
	int tracks = (ui->advOutRecTrack1->isChecked() ? (1 << 0) : 0) |
		     ...
		     (ui->advOutRecTrack7->isChecked() ? (1 << 6) : 0) |
		     (ui->advOutRecTrack8->isChecked() ? (1 << 7) : 0) |
		     (ui->advOutRecTrack9->isChecked() ? (1 << 8) : 0) |
		     (ui->advOutRecTrack10->isChecked() ? (1 << 9) : 0) |
		     (ui->advOutRecTrack11->isChecked() ? (1 << 10) : 0) |
		     (ui->advOutRecTrack12->isChecked() ? (1 << 11) : 0);
	return tracks;
}
...
void OBSBasicSettings::UpdateMultitrackVideo()
{
	...
	auto update_advanced_output_audio_tracks = [&](bool mtv_enabled) {
		...
		auto track7_warning_visible = mtv_enabled &&
					      (ui->advOutTrack7->isChecked() ||
					       vod_track_idx_enabled(7));
		auto track7_disabled = track7_warning_visible &&
				       !ui->advOutRecTrack7->isChecked();
		...
		auto track8_warning_visible = mtv_enabled &&
					      (ui->advOutTrack8->isChecked() ||
					       vod_track_idx_enabled(8));
		auto track8_disabled = track8_warning_visible &&
				       !ui->advOutRecTrack8->isChecked();
		...
		auto track9_warning_visible = mtv_enabled &&
					      (ui->advOutTrack9->isChecked() ||
					       vod_track_idx_enabled(9));
		auto track9_disabled = track9_warning_visible &&
				       !ui->advOutRecTrack9->isChecked();
		...
		auto track10_warning_visible = mtv_enabled &&
					      (ui->advOutTrack10->isChecked() ||
					       vod_track_idx_enabled(10));
		auto track10_disabled = track10_warning_visible &&
				       !ui->advOutRecTrack10->isChecked();
		...
		auto track11_warning_visible = mtv_enabled &&
					      (ui->advOutTrack11->isChecked() ||
					       vod_track_idx_enabled(11));
		auto track11_disabled = track11_warning_visible &&
				       !ui->advOutRecTrack11->isChecked();
		...
		auto track12_warning_visible = mtv_enabled &&
					      (ui->advOutTrack12->isChecked() ||
					       vod_track_idx_enabled(12));
		auto track12_disabled = track12_warning_visible &&
				       !ui->advOutRecTrack12->isChecked();
